 ...
 */
	public function create($model = null, $options = array()) {
		...
		if ($options['action'] === null && $options['url'] === null) {
            //print_r($this->request->here(false));exit;
		...
		$this->requestType = strtolower($options['type']);//By Ahmad Nabulsi
        $jurl = str_replace(Configure::read('App.baseUrl'), "", $this->url($options['action']));//By Ahmad Nabulsi
        
		$action = reform_url($jurl);//By Ahmad Nabulsi
