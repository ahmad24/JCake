<?php
JToolbarHelper::title('Test Index');//JToolbarHelper::title('Test Index', 'link weblinks')

JToolbarHelper::apply('jcake.apply');
JToolbarHelper::save('jcake.save');
JToolbarHelper::save2copy('jcake.save2copy');
JToolbarHelper::cancel('jcake.cancel');

JToolbarHelper::save2new('jcake.save2new');
