 ...
 */
	public function link($title, $url = null, $options = array(), $confirmMessage = false) {
		...
		if ($url !== null) {
            ...
            $url = reform_url($url);//By Ahmad Nabulsi
            
		} else {
			$url = reform_url($this->url($title));//By Ahmad Nabulsi
 ...
 */
	public function image($path, $options = array()) {
		...
		if ($url) {
			return sprintf($this->_tags['link'], reform_url($this->url($url)), null, $image);//By Ahmad Nabulsi
		}
		return $image;
	}
